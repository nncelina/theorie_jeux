...
\begin{verbatim}
 Résultats pour biais = 0.25
\end{verbatim}

\begin{verbatim}
--- ANALYSE DE L'ÉQUILIBRE ---
Nombre de messages distincts possibles : 2
ÉTAT : Communication Partielle. L'investisseur connaît la zone, mais pas le prix exact.
\end{verbatim}

\includegraphics{_main_files/figure-latex/unnamed-chunk-4-1.pdf}

L'exploration interactive est disponible dans le notebook :
\href{https://colab.research.google.com/drive/1jELjoJmYpHdWqcoe-Yr6wzzNHnt5a2hK?usp=sharing}{Notebook interactif}
