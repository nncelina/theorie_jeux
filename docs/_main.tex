...
Le script utilisé calcule l'\textbf{Équilibre Bayésien Parfait} du jeu en fonction du paramètre de biais que vous choisissez via le curseur :
...
\href{https://chroma-vine-47131463.figma.site/}{Visualisation interactive}
...
\chapter*{References bibliographiques}\label{references-bibliographiques}
\addcontentsline{toc}{chapter}{References bibliographiques}

Crawford, V. P., \& Sobel, J. (1982). \emph{Strategic information transmission}. \textbf{Econometrica}, 50(6), 1431--1451.
\url{https://www.jstor.org/stable/1913390}
\url{https://web.stanford.edu/~jdlevin/Econ\%20286/CrawfordSobel.pdf}

Farrell, J., \& Rabin, M. (1996). \emph{Cheap talk}. \textbf{Journal of Economic Perspectives}, 10(3), 103--118.
\url{https://www.aeaweb.org/articles?id=10.1257/jep.10.3.103}

Fudenberg, D., \& Tirole, J. (1991). \emph{Game theory}. Cambridge, MA: MIT Press.

Gibbons, R. (1992). \emph{Game theory for applied economists}. Princeton, NJ: Princeton University Press.

Mas-Colell, A., Whinston, M. D., \& Green, J. R. (1995). \emph{Microeconomic theory}. Oxford: Oxford University Press.
